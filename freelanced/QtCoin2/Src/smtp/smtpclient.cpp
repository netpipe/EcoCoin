...
bool SmtpClient::connectToHost()
{
    ...
    case TcpConnection:
        ...
        break;
    case SslConnection:
        ((QSslSocket*) socket)->setPrivateKey("server.key", QSsl::Rsa);
        ((QSslSocket*) socket)->setLocalCertificate("server.crt");
...
void SmtpClient::socketStateChanged(QAbstractSocket::SocketState state/*state*/)
{
    qDebug() << "State:"<<state;
}

void SmtpClient::socketError(QAbstractSocket::SocketError err/*socketError*/)
{
    qDebug() << "Err:"<<err;
}
