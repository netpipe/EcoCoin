    ...
    , ui(new Ui::MainWindow)
{
    ...
    // UI Init
    QObject::connect(ui->wdt_Wallet, SIGNAL(WalletUserInserted()), this, SLOT(updateWalletUserList()));
    QObject::connect(ui->cmbUsers, SIGNAL(currentIndexChanged(QString)), this, SLOT(currentWalletUserChanged(QString)));
...
void MainWindow::updateWalletUserList()
{
    ui->cmbUsers->addItems(m_Engine->GetWalletUserList());
}
void MainWindow::currentWalletUserChanged(QString strUser)
{
    ui->wdt_Wallet->SetUserID(strUser);
