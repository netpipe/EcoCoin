...
void MainWindow::insertUserNoAdmin() //strictly a db to hold all userid's for verification
{
    createUserTable();
    ...
    QString crypted2 = simplecrypt(ui->lineEditName_2->text(),masterkey.toLatin1(),QCryptographicHash::Sha512);
    ...
    query.append("INSERT INTO users("
                 ...
                 "VALUES("
                 "'"+ui->lineEditSurname_2->text()+"',"
                                                         "'"+crypted2.toLatin1()+"',"
                                                                                 "'"+ui->lineEditSurname_2->text()+"',"
                                                                                                                        "'"+ui->lineEditPassword_2->text().toLatin1()+"',"
                                                                                                                                                                    "'"+ui->lineEditPhone->text().toLatin1()+"',"
                                                                                                                                                                                                             "'"+ui->createuserdatetime->text()+"',"
                                                                                                                                                                                                                                                "'"+ masterkey.toLatin1() +"'," //ekey
                 "'""'," //ammount
